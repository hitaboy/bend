<?php
/*
Plugin Name: ACF: Image Crop and renditions Add-on
Plugin URI: https://github.com/
Description: An image field making it possible/required for the user to crop the selected image to the specified image size or dimensions that saves retina and non retina renditions of the crop
Version: 1.0
Author: Pere Esteve
Author URI: http://hodiern.com
